...
<section
    class="top10-row relative py-0 {isRowHovered ? 'z-[200]' : 'z-0'}"
    ...
    <div class="slider-container relative group" onwheel={handleWheel}>
        ...
        >
            ...
            <div
                ...
                class="slider-track flex gap-1 py-4 pb-6 transition-transform duration-500 ease-out focus:outline-none focus-visible:ring-2 focus-visible:ring-white"
